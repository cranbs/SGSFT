...
from basicsr.archs.frequency_block import MSFB

from .kaimodules import ConvNormAct, image2token, token2image, PartialConv2d
...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask_windows=None, mask=None):
        ...
        if mask_windows is not None:
            ...
            attn_mask_windows = float(100.0) * (mask_windows.squeeze(-1).unsqueeze(1).unsqueeze(1) - 1.)
            attn = attn + attn_mask_windows
